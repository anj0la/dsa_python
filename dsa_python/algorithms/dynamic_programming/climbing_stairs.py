...
def climbing_stairs_optimization(n: int) -> int:
    """
    You are climbing a staircase. It takes n steps to reach the top.
    Each time you can either climb 1 or 2 steps. In how many distinct ways can you climb to the top?
...
if __name__ == '__main__':
    assert climbing_stairs_recursion(5) == climbing_stairs(5) == climbing_stairs_optimization(5)
    assert climbing_stairs_recursion(10) == climbing_stairs(10) == climbing_stairs_optimization(10)

    print(climbing_stairs_recursion(2))
    print(climbing_stairs(2))
    print(climbing_stairs_optimization(2))
    print(climbing_stairs_recursion(3))
    print(climbing_stairs(3))
    print(climbing_stairs_optimization(3))